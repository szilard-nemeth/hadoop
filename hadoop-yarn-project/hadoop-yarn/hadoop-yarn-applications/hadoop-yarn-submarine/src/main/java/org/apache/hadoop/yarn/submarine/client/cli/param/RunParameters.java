...
public abstract class RunParameters extends BaseParameters {
  ...
  @Override
  public void updateParametersByParsedCommandline(ParametersHolder parametersHolder, ClientContext clientContext) throws ParseException,
  ...
  private List<String> getEnvVars(ParametersHolder parametersHolder) {
    ...
    List<String> envVarsArray = parametersHolder.getOptionValues(CliConstants.ENV);
