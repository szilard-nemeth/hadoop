...
public class RunJobParameters extends RunParameters {
  ...
  @Override
  public void updateParametersByParsedCommandline(ParametersHolder parametersHolder, ClientContext clientContext)
      throws ParseException, IOException, YarnException {

    String input = parametersHolder.getOptionValue(CliConstants.INPUT_PATH);
    String jobDir = parametersHolder.getOptionValue(CliConstants.CHECKPOINT_PATH);
    int nWorkers = 1;
    ...
    if (nPS > 0) {
      String psResourceStr = parametersHolder.getOptionValue(CliConstants.PS_RES);
    ...
    super.updateParametersByParsedCommandline(
        parametersHolder, clientContext);
  }
